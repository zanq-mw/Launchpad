...
function UserApplicationsInfo(props) {
  ...
  const interviewRequestedApplications = jsonData.data
  ...
  return (
    <Card
      sx={{
        ...MyApplicationStyles.cardMargin,
        paddingTop: "15px",
        paddingBottom: "15px",
      }}
    >
          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={MyApplicationStyles.tableHeader} align="center">
                  Company
                </TableCell>
                <TableCell sx={MyApplicationStyles.tableHeader}>
                  Date of Application
                </TableCell>
                <TableCell sx={MyApplicationStyles.tableHeader}>
                  Status
              ...
              {mockApplicationData
                ...
                .map((item, index) => (
                  <TableRow>
                    ...
                    <TableCell>
                      <Typography
                        style={MyApplicationStyles.jobTitle}
                        align="center"
                      >
                        <img
                          src={item.logo}
                      ...
                      <Typography
                        style={MyApplicationStyles.companyName}
                        align="center"
                      >
                        {item.companyName}
                      </Typography>
  ...
  return (
    <div style={MyApplicationStyles.pageContainer}>
      <Typography
        variant="h5"
        component="div"
        sx={MyApplicationStyles.mainTitle}
      >
        My Applications
      </Typography>
      ...
      <Typography
        variant="h5"
        component="div"
        sx={MyApplicationStyles.subTitle}
      >
        Applications
      </Typography>
...
export function MyApplication({ userId, setUserId }) {
  ...
  return <MyApplicationItems data={data} transformedData={transformedData} />;
}
