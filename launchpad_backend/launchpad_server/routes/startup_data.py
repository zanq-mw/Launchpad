...
user = {
    ...
    "records": [{
        ...
        "school": "Ryerson University",   # Leave key pair value blank if school not specify
...
posting = {
    ...
    Microsoft is an equal opportunity employer. Consistent with applicable law, all qualified applicants will receive consideration for employment without regard to age, ancestry, citizenship, color, family or medical care leave, gender identity or expression, genetic information, immigration status, marital status, medical condition, national origin, physical or mental disability, political affiliation, protected veteran or military status, race, ethnicity, religion, sex (including pregnancy), sexual orientation, or any other characteristic protected by applicable local laws, regulations and ordinances. If you need assistance and/or a reasonable accommodation due to a disability during the application process, read more about requesting accommodations.""",
        "deadline": datetime(2023, 11, 8, 7, 30, 54),
        "workModel": "Hybrid",
        "companyId": 1,
        "type": "New Grad",
    ...
    Microsoft is an equal opportunity employer. Consistent with applicable law, all qualified applicants will receive consideration for employment without regard to age, ancestry, citizenship, color, family or medical care leave, gender identity or expression, genetic information, immigration status, marital status, medical condition, national origin, physical or mental disability, political affiliation, protected veteran or military status, race, ethnicity, religion, sex (including pregnancy), sexual orientation, or any other characteristic protected by applicable local laws, regulations and ordinances. If you need assistance and/or a reasonable accommodation due to a disability during the application process, read more about requesting accommodations.""",
    "deadline": datetime(2023, 11, 15, 7, 30, 54),
    "workModel": "Hybrid",
    "companyId": 1,
    "type": "Internship",
    ...
    "deadline": datetime(2023, 12, 15, 7, 30, 54),
    "workModel": "Hybrid",
    "companyId": 2,
    "type": "Internship",
    "location": "Mountain View, US", # Leave key pair value blank if location not specify
    ...
    "deadline": datetime(2023, 12, 20, 7, 30, 54),
    "workModel": "Hybrid",
    "companyId": 2,
    "type": "New Grad",
    ...
    "deadline": datetime(2023, 11, 20, 7, 30, 54),
    "workModel": "Hybrid",
    "companyId": 3,
    "type": "Internship",
    "location": "Amazon Portland, US", # Leave key pair value blank if location not specify
    ...
    "deadline": datetime(2023, 12, 30, 7, 30, 54),
    "workModel": "Hybrid",
    "companyId": 4,
    "type": "Internship",
    "location": "Toronto, Canada", # Leave key pair value blank if location not specify
